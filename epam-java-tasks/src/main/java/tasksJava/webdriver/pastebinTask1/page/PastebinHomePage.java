...
public class PastebinHomePage {
    ...
    public PastebinNewPasteCreated fillRequiredFieldAndCreate(String codePattern, String pasteName) {
        ...
        return new PastebinNewPasteCreated(driver, codePattern, pasteName);
